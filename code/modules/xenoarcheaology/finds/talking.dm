...
/datum/talking_atom/proc/catchMessage(var/msg, var/mob/source)
	...
	if(prob(30))
		...
		holder_atom.loc.visible_message("<font color='#6F6FE2'>\icon[holder_atom] [pick(options)]</font>")
...
/datum/talking_atom/proc/SaySomething(var/word = null)
	...
	for(var/mob/M in listening)
		M << "\icon[holder_atom] <b>[holder_atom]</b> reverberates, \"<font color='#6F6FE2'>[msg]</font>\""
