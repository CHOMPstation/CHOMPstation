...
/obj/machinery/portable_atmospherics/hydroponics/attack_generic(var/mob/user)
	...
	if(istype(user,/mob/living/carbon/alien/diona))
		...
		if(weedlevel > 0)
			...
			weedlevel = 0
			nymph.visible_message("<font color='#6F6FE2'><b>[nymph]</b> begins rooting through [src], ripping out weeds and eating them noisily.</font>","<font color='#6F6FE2'>You begin rooting through [src], ripping out weeds and eating them noisily.</font>")
		else if(nymph.nutrition > 100 && nutrilevel < 10)
			nymph.nutrition -= ((10-nutrilevel)*5)
			nutrilevel = 10
			nymph.visible_message("<font color='#6F6FE2'><b>[nymph]</b> secretes a trickle of green liquid, refilling [src].</font>","<font color='#6F6FE2'>You secrete a trickle of green liquid, refilling [src].</font>")
		else
			nymph.visible_message("<font color='#6F6FE2'><b>[nymph]</b> rolls around in [src] for a bit.</font>","<font color='#6F6FE2'>You roll around in [src] for a bit.</font>")
		return
