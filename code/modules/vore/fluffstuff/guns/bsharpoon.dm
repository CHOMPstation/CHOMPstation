...
/obj/item/weapon/teleport_cane
	name = "Gentleman's Cane of Teleportation"
	desc = "Stylish, yet very functional"
...
/obj/item/weapon/teleport_cane/afterattack(atom/A, mob/user as mob)
	var/current_fire = world.time
	if(!user || !A)
		return
	if(transforming)
...
/obj/item/weapon/teleport_cane/attack_self(mob/living/user as mob)
	return chande_fire_mode(user)
