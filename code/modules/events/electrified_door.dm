...
/datum/event/electrified_door/setup()
	...
	for(var/i in 1 to 10)
		...
		message_admins("area [A.name]")
		message_admins("area [A]")
		...
		for(var/obj/machinery/door/airlock/target_door in target_doors)
			message_admins("door [target_door]")
...
/datum/event/electrified_door/start()
	...
	var/log_message = "Event electrifies door at ([chosen_door.x], [chosen_door.y], [chosen_door.z])"
