...
/obj/item/rig_module/vision/engage()
	...
	if(starting_up)
		holder.wearer << "<font color='#6F6FE2'>You activate your visual sensors.</font>"
		return 1
	...
	if(vision_modes.len > 1)
		...
		holder.wearer << "<font color='#6F6FE2'>You cycle your sensors to <b>[vision.mode]</b> mode.</font>"
	else
		holder.wearer << "<font color='#6F6FE2'>Your sensors only have one mode.</font>"
	return 1
