...
/obj/item/pipe/proc/update()
	...
	// TODO - Some way to determine what icon state to use! Turns out we don't have a var on it.
...
/obj/item/pipe_meter/proc/setAttachLayer(new_layer = PIPING_LAYER_DEFAULT)
	piping_layer = new_layer
	pixel_x = PIPE_PIXEL_OFFSET_X(new_layer)
	pixel_y = PIPE_PIXEL_OFFSET_Y(new_layer)
